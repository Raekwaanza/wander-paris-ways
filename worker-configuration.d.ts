/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31392d785b1f93ae2a036a0dcaf28204)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	SCENIC_API_BURST_RATE_LIMITER: RateLimit;
	SCENIC_API_SUSTAINED_RATE_LIMITER: RateLimit;
	SCENIC_GEOCODING_RATE_LIMITER: RateLimit;
	SCENIC_ROUTING_RATE_LIMITER: RateLimit;
	SCENIC_MATRIX_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTESERVICE_API_KEY" | "MAPTILER_API_KEY">> {}
}
